...
# --- 1. Manually enter all your data into pandas DataFrames ---
...
# d) Plant/Machine Data (representing generators)
# We assume the first entry (bus 1) is the slack bus (external grid)
...
# e) Two-Winding Transformer Data (if any)
# Example data for two transformers
...
# --- 2. Create an empty pandapower network ---
net = pp.create_empty_network()

# --- 3. Add buses to the network ---
bus_num_to_pp_idx = {}
...
# --- 4. Add network elements ---

# a) Add Two-Winding Transformers
...
# e) Add Generators (Machines/Plants)
...
# Add the following lines to generate the plot
try:
    # plot the network
    ...
    # It's also a good idea to run the diagnostic tool
    pp.diagnostic(net)
