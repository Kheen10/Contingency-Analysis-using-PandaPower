...
# --- Configuration ---
# IMPORTANT: Update this path to your desired MATPOWER .m file
raw_path = r"L:\E21\SEM07\Data Analytics\Project 01 Repo\case14.m"

# Define frequency (usually 60Hz for IEEE cases)
system_frequency_hz = 50

# --- Load Network from MATPOWER .m file ---
try:
...
# --- Optional: Print full results tables ---
print("\n--- Full Bus Results ---\n", net.res_bus)
print("\n--- Full Line Results ---\n", net.res_line)
